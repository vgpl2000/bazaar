...
class ProductBloc extends Bloc<ProductEvents.ProductEvent, ProductState> {
  final GetProducts getProducts;

  ProductBloc(this.getProducts) : super(ProductLoading()) {
    on<ProductEvents.FetchProducts>(_onFetchProducts);
  }

  Future<void> _onFetchProducts(
      ProductEvents.FetchProducts event, Emitter<ProductState> emit) async {
    emit(ProductLoading());
    try {
